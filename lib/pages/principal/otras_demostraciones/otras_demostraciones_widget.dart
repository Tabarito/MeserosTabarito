            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  StreamBuilder<List<ImagenesTabaritoRecord>>(
                    stream: queryImagenesTabaritoRecord(),
                    builder: (context, snapshot) {
                      ...
                      List<ImagenesTabaritoRecord>
                          containerImagenesTabaritoRecordList = snapshot.data!;
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            width: 400.0,
                            height: 300.0,
                            child: custom_widgets.CarouselMenu(
                              width: 400.0,
                              height: 300.0,
                              jsonMenuItems: FFAppState().jsonMenuItems,
                            ),
                          ),
                        ),
                      );
