                    ...
                    Expanded(
                      child: StreamBuilder<List<RestauranteRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<RestauranteRecord>
                              containerRestauranteRecordList = snapshot.data!;
                          return Container(
                            width: 420.0,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            setState(() {
                                                                              FFAppState().montoFinalProductos = functions.tListaP(txtTotalProductosSubProductosRecordList.map((e) => e.subTotal).withoutNulls.toList().where((e) => e == e).toList());
                                                                            });
                                                                          },
                                                                          child:
                                                                              Text(
                                                                            functions.tListaP(txtTotalProductosSubProductosRecordList.map((e) => e.subTotal).withoutNulls.toList().where((e) => e == e).toList()).toString(),
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              StreamBuilder<
                                                                ...
                                                                stream:
                                                                    querySubProductosRecord(
                                                                  queryBuilder: (subProductosRecord) => subProductosRecord.where(
                                                                      'QuienCompraProducto',
                                                                      arrayContains:
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            ProductoRecord>(
                                                                          stream:
                                                                              ProductoRecord.getDocument(lVCarritoProductosSubProductosRecord.parentReference),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return InkWell(
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              setState(() {
                                                                                FFAppState().montoFinalCombos = functions.tListaP(txtTotalCombosSubCombosRecordList.map((e) => e.subTotalCombo).withoutNulls.toList().where((e) => e == e).toList());
                                                                              });
                                                                            },
                                                                            child:
                                                                                Text(
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        final lVCarritoComboSubCombosRecord =
                                                                            lVCarritoComboSubCombosRecordList[lVCarritoComboIndex];
                                                                        return Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(
                                                                              0.0,
                                                                              20.0,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              final containerComboRecord = snapshot.data!;
                                                                              return Container(
                                                                                width: 100.0,
                                                                                height: 100.0,
                                                                                decoration: BoxDecoration(
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'v8f9ise1' /* Por favor presiona los montos ... */,
                                                              ),
                                                              maxLines: 2,
                                                              style: FlutterFlowTheme
                                                                      .of(context)
